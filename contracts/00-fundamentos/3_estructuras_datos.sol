...
contract data_structures {
    ...
    Customer customer_1 = Customer(1, "Fabian", "fabian@gmail.com");

    Customer customer_2 = Customer(2, "Pepe", "pepe@gmail.com");
    ...
    // Array dinñámico de tipo cliente
    ...
    function array_modification (uint256 _id, string memory _name, string memory _email) public {
        ...
        // dynamic_list_customer.push(Customer(_id, _name, _email)); // Se puede hacer de esta manera o con una variable previa como a continuación
    ...
    // Asignacion de una estructura de datos a una dirección
